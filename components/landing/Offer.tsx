      ...
      <Container>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          ...
          <div className="border-primary/20 bg-primary/5 flex flex-col rounded-2xl border p-8">
            ...
            <p className="text-muted-foreground mt-5 text-sm leading-relaxed">
              40+ Claude Code skills, 11 custom agents, MCP server configs, and
              the multi-tenancy + AI modules. The workflow layer that turns a
              boilerplate into a build-anything machine.
            </p>
            <div className="mt-8 flex flex-wrap gap-2">
              {PRO_FEATURES.map((f) => (
                <FeatureChip key={f} label={f} />
